...
public class EmptyLayout {
    ...
    private String mErrorMessage = "抱歉,出现了一点问题";
    private String mEmptyMessage = "暂无记录";
    ...
    private boolean mShowEmptyImage=true;
    ...
    public boolean ismShowEmptyImage() {
        return mShowEmptyImage;
    }
    ...
    private void changeEmptyType() {
        ...
        if (!mViewsAdded) {
            ViewGroup group = new RelativeLayout(mContext);
            ViewGroup parent = (ViewGroup) mItemView.getParent();
            if (parent instanceof LinearLayout) {
                LinearLayout.LayoutParams parentPatams= (LinearLayout.LayoutParams) mItemView.getLayoutParams();
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT,parentPatams.weight);
                ...
                if (mLoadingView != null)
                    mLoadingView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
                if (mErrorView != null)
                    mErrorView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
                ...
                group.setLayoutParams(parent.getLayoutParams());
            }

            if (mEmptyView != null) group.addView(mEmptyView);
            if (mLoadingView != null) group.addView(mLoadingView);
            if (mErrorView != null) group.addView(mErrorView);
            mViewsAdded = true;


            parent.addView(group);
            if (mItemView instanceof ListView)
                ((ListView) mItemView).setEmptyView(group);
            if (mItemView instanceof GridView)
                ((GridView) mItemView).setEmptyView(group);
        }
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            ...
            if(mShowEmptyImage){
//                TextView view=(TextView)mEmptyView.findViewById(R.id.textViewMessage);
//                view.setCompoundDrawables(null,null,null,null);
     ...
     *
     * @param context  the context (preferred context is any activity)
     * @param itemView the list view for which this library is being used
     */
    public EmptyLayout(Context context, View itemView) {
        mContext = context;
        mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mItemView = itemView;
    }
